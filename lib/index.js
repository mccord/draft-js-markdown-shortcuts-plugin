...
function checkReturnForState(editorState, ev) {
  ...
  if (text === '---') {
    newEditorState = (0, _changeCurrentBlockType2.default)(editorState, 'horizontal-rule', '');
    return (0, _insertEmptyBlock2.default)(newEditorState);
  }

  if (/-list-item$/.test(type) && text === '') {
    return (0, _leaveList2.default)(editorState);
  }

  if (type !== 'code-block' && /^```([\w-]+)?$/.test(text)) {
    return (0, _handleNewCodeBlock2.default)(editorState);
  }
